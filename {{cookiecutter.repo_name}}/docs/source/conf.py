...
copyright = u'2015, {{ cookiecutter.authors }}'
...
texinfo_documents = [
  ('index', '{{ cookiecutter.repo_name }}', u'{{ cookiecutter.repo_name }} Documentation',
   u'{{ cookiecutter.authors }}', '{{ cookiecutter.repo_name }}', 'One line description of project.',
   'Miscellaneous'),
]
